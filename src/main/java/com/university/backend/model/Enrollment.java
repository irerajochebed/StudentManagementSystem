...
public class Enrollment {
    ...
    // assignGrade now throws exception for invalid grades
    public void assignGrade(double gradePoints) {

        // Validate grade range
        if (gradePoints < 0.0 || gradePoints > 4.0) {
            throw new com.university.backend.exception.InvalidGradeException(gradePoints);
        }
        ...
        System.out.println("  Grade " + getLetterGrade() + " assigned to " + student.getFullName() + " for " + course.getCourseName());
    }
